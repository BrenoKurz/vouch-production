...
const supportEmail =
  process.env.EXPO_PUBLIC_SUPPORT_EMAIL || "support@vouchdating.com";

export default function AccountScreen() {
  const { session, signOut, updateCommunicationPreferences, updatePassword } =
    useAuth();
  ...
  async function savePreferences(nextEmailValue: boolean) {
    ...
    try {
      ...
      setErrorMessage(
        error instanceof Error
          ? error.message
          : "We could not save that preference.",
      );
    } finally {
      ...
      >
        ...
        >
          ...
          <Text style={styles.subtitle}>
            Control how you hear from Vouch and understand how your information
            is used.
          </Text>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.card}>
              ...
              />
              {passwordMessage ? (
                <InlineNotice message={passwordMessage} tone="positive" />
              ) : null}
              <AppButton
            ...
            <View style={styles.card}>
              <View style={styles.switchRow}>
                ...
                <View style={styles.switchCopy}>
                  ...
                  <Text style={styles.rowBody}>
                    Introductions, messages, date changes, debriefs, and safety
                    updates.
                  </Text>
                </View>
                <Switch
                  disabled
                  value
                  trackColor={{ true: palette.sageSoft }}
              ...
              <View style={styles.switchRow}>
                ...
                <View style={styles.switchCopy}>
                  ...
                  <Text style={styles.rowBody}>
                    Product news and membership guidance. Essential account
                    email is unaffected.
                  </Text>
                </View>
                <Switch
              ...
              {preferenceMessage ? (
                <Text style={styles.savedText}>{preferenceMessage}</Text>
              ) : null}
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.linkCard}>
              <LinkRow
                ...
                onPress={() => router.push("/trust-center" as Href)}
              />
              <LinkRow
                icon="sparkles-outline"
                label="AI matchmaking controls"
                onPress={() => router.push("/ai-matchmaker")}
              />
              <LinkRow
                icon="alert-circle-outline"
                label="Your safety reports"
                onPress={() => router.push("/safety-cases")}
              />
              <LinkRow
                icon="help-buoy-outline"
                label="Contact Vouch support"
                onPress={() =>
                  void openSupport(
                    "Vouch member support",
                    "How can the Vouch team help?",
                  )
                }
                isLast
              />
          ...
          <View style={styles.dangerCard}>
            ...
            <Text style={styles.dangerBody}>
              Ask for a copy of your information or begin a verified deletion
              request with the privacy team.
            </Text>
            <Pressable
              onPress={() => router.push("/privacy-requests" as Href)}
  ...
  return (
    <View style={styles.settingRow}>
      ...
      <View style={styles.switchCopy}>
        ...
        <Text style={styles.rowBody}>{value}</Text>
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: palette.brand, ...typography.label },
  title: { color: palette.ink, marginTop: space.xs, ...typography.title },
  subtitle: {
    color: palette.muted,
  ...
  settingRow: { alignItems: "center", flexDirection: "row", gap: space.sm },
  settingIcon: {
    alignItems: "center",
  ...
  switchCopy: { flex: 1 },
  rowTitle: { color: palette.ink, ...typography.bodyStrong },
  rowBody: { color: palette.muted, marginTop: 2, ...typography.small },
  divider: {
    backgroundColor: palette.border,
    height: StyleSheet.hairlineWidth,
    marginVertical: space.xs,
  },
  fieldLabel: { color: palette.inkSoft, ...typography.caption },
  input: {
  ...
  switchRow: { alignItems: "center", flexDirection: "row", gap: space.sm },
  savedText: {
    color: palette.sage,
    marginTop: space.xs,
    ...typography.caption,
  ...
  linkLabel: { color: palette.ink, flex: 1, ...typography.bodyStrong },
  dangerCard: {
  ...
  dangerTitle: { color: palette.ink, ...typography.heading },
  dangerBody: {
  ...
  outlineButtonText: { color: palette.ink, ...typography.bodyStrong },
  deleteButton: {
    alignItems: "center",
    justifyContent: "center",
    marginTop: space.xs,
  ...
  deleteButtonText: { color: palette.danger, ...typography.bodyStrong },
